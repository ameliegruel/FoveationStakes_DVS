...
if plot_all or args.plot_values:
    ...
    for i,target in enumerate(target_labels):
        ...
        print(data_to_plot_samples[target]['temporal density'])
    ...
    fig.suptitle('Statistics per target - ground truth')
    fig.tight_layout()
    ...
    for i,target in enumerate(target_labels):
        ...
        getConfidenceEllipse(data_to_plot_output[target]['nb events'], data_to_plot_output[target]['temporal density'], axes[i], facecolor='black', alpha=0.2)
